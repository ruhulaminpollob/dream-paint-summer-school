...
const Footer = () => {
    return (
        <footer className=" max-w-7xl mx-auto pt-10 text-white">
            <div className="footer grid md:grid-cols-3 justify-around">
                ...
                <div>
                    <span className="footer-title">Dream Paint</span>
                    <a className="link link-hover">About us</a>
                    <a className="link link-hover">See Classes</a>
                    <a className="link link-hover">See Instructors</a>
                </div>
