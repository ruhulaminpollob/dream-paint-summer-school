        ...
        <div className="navbar max-w-7xl mx-auto  text-white">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className=" z-50 menu-sm text-black dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        {navLink}
                    </ul>
                </div>
                <Link className='text-center w-fit' to="/">
                    ...
                    <h2 className='text-lg md:text-2xl  font-bold text-cyan-400'>Dream<span className='text-red-400'>Paint</span></h2>
                </Link>
            </div>
                    ...
                    user ?
                        <div className='flex gap-3'>
                            ...
                            <button onClick={handleLogOut} className="hover:text-cyan-400">
                                <BiLogOut className="text-2xl hover:text-red-400 " title="Log Out"></BiLogOut>
